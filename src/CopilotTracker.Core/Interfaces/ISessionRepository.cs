...
public interface ISessionRepository
{
    ...
    Task<PagedResult<Session>> ListAsync(string? machineId = null, string? status = null, string? tool = null, DateTime? since = null, string? continuationToken = null, int pageSize = 50);
